...
class PneumoniaVGG16(LightningModule):
    def __init__(self,
        ...
        self.model.classifier = nn.Sequential(
            nn.Linear(self.hparams.num_features * 7 * 7, self.hparams.num_features * 8 ),
            nn.ReLU(),
            nn.Dropout(self.hparams.dropout),
            nn.Linear(self.hparams.num_features * 8, self.hparams.num_features * 8),
            nn.ReLU(),
            nn.Dropout(self.hparams.dropout),
            nn.Linear(self.hparams.num_features * 8, self.hparams.num_classes),
        )
